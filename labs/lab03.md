...
1. Mettre en place du cache des packages npm pour que le run de la pipeline soit plus rapide.
2. Réfléchir à comment parallèliser certaines tâches afin d'optimiser le temps d'exécution
